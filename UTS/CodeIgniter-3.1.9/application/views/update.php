...
<h1 class="page-header text-center" align="center">
    ...
    <div><?= validation_errors() ?></div>
      <?= form_open_multipart('beranda/edit',['class'=>'form-horizontal']) ?>
	<div class="container">
		<form class="form-group" method="POST" action="">
			<table align="center" width="50%">
				...
				<tr>
					<td>Deskripsi</td>
					<td><input type="text" name="deskripsi" class="form-control" value="<?php echo $deskripsi; ?>"></td>
				</tr>
        <tr>
          <td>Gambar Buku</td>
          <td><input type="file" name="userfile" class="form-control"></td>
			...
			<button type="submit" class="btn btn-primary"> <span class="glyphicon glyphicon-pencil">Save</span></button>
		</form>
	</div>
</body>
</html>